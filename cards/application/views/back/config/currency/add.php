<div id="main">
    ...
    <div id="main-content"> 
		<div class="page-title mb-3">
			<div class="row">
				<div class="col-12 col-md-6 order-md-1 order-last">
					<h3>اضافة عملة جديدة</h3>
					<p class="text-subtitle text-muted">اضافة عملة جديدة</p>
				</div>
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="currency">اضافة عملة جديدة</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>config/new_currency" class="form form-horizontal needs-validation" novalidate>
					...
					<div class="col-lg-6"> 
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">اضافة عملة جديدة</h4> 
							</div>
										...
										<div class="<?php if($l->lang_active == 0) echo "d-none";?>">
											...
											<div class="row"> 
												...
												<div class="col-md-9 form-group">
													<input type="text" class="form-control form-control-lg" name="currency_name[<?= $short?>]" required> 
												</div>
											</div>
											<div class="row"> 
												<div class="col-md-3">
												...
												<div class="col-md-9 form-group">
													<input type="text" class="form-control form-control-lg" name="currency_short[<?= $short?>]" required> 
												</div>
											</div>
										</div> 
										<hr class="my-3">  
