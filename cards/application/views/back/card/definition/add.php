<div id="main">
    ...
    <div id="main-content"> 
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>card/add_card" class="form form-horizontal" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="form-body">
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												<input type="tel" class="form-control form-control-lg" name="card_wholesale_price" required>	
											</div>
										</div>
										<div class="form-group row">
											<div class="col-md-4">
											...
											<div class="col-md-8">
												<input type="tel" class="form-control form-control-lg" name="card_price" required>	
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												<input type="text" class="form-control form-control-lg" name="card_time_to_do">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="need_approval" id="need_approval_yes" value="0" checked>
													<label class="form-check-label" for="need_approval_yes">
														لا تحتاج موافقة
													</label>
												</div>
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="need_approval" id="need_approval_no" value="1">
