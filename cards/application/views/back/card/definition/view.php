<div id="main">
    ...
    <div id="main-content"> 
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>card/update_card" class="form form-horizontal" enctype="multipart/form-data">
								...
								<div class="card-body">
									<div class="form-body">
											<div class="form-group row mb-4">
												...
												<div class="col-md-8">
													<div class="upload-pic-box">
														...
														<input type="file" class="form-control d-none upload-pic" id="profile_pic" name="card_pic" id="formFile">
    										...
    										<div class="form-group row">
    											...
    											<div class="col-md-8">
    												<input type="tel" class="form-control form-control-lg" name="card_wholesale_price" value="<?= $view->card_wholesale_price?>" required>	
    											</div>
    										</div>
											<div class="form-group row">
												<div class="col-md-4">
												...
												<div class="col-md-8">
													<input type="tel" class="form-control form-control-lg" name="card_price" value="<?= $view->card_price?>" required>	
												</div>
											</div>
											...
											<div class="form-group row">
												<div class="col-md-4">
													<label>تحتاج موافقة</label>
												</div> 
												<div class="col-md-8">
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" name="need_approval" id="need_approval_yes" value="0" <?php if($view->need_approval == 0) echo "checked";?>>
														<label class="form-check-label" for="need_approval_yes">
															لا تحتاج موافقة
														</label>
													</div>
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" name="need_approval" id="need_approval_no" value="1" <?php if($view->need_approval == 1) echo "checked";?>>
														<label class="form-check-label" for="need_approval_no">
															نعم تحتاج
														</label>
													</div>
												</div>
