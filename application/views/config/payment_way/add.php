<div id="main">
    ...
    <div id="main-content"> 
				...
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">اضافة بطاقة دفع جديد</li> 
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>config/add_payment_way" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
					...
					<div class="col-lg-12"> 
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">اضافة بطاقة دفع جديد</h4> 
							</div>
									...
									<div class="form-body">
										<div class="row ">
											...
											<div class="col-lg-4 order-md-6 col-md-12"> 
												<input type="file" class="form-control" name="payment_way_pic" id="formFile" required> 
										...
										<div class="<?php if($l->lang_active == 0) echo "d-none";?>">
											...
											<div class="row"> 
												...
												<div class="col-md-9 form-group">
													<input type="text" class="form-control form-control-lg" name="payment_way_name[<?= $short?>]"> 
												</div>
												...
												<div class="col-md-9 form-group">
													<textarea rows="5" type="text" class="form-control form-control-lg " name="payment_way_details[<?= $short?>]"></textarea>
												</div>
												<hr class="my-3"> 
											</div>
											<?php }?>
