			...
			<div class="row"> 
									...
									<div class="row mb-4">
										...
										<div class="col-md-4">
											<div class="upload-pic-box">
												...
												<input type="file" class="form-control d-none upload-pic" id="profile_pic" name="user_pic" id="formFile" required>
				...
				<div class="col-lg-6">
					<div class="card">
						...
						<form id="form" method="post" action="<?= site_url()?>config/update_password" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
						<input type="hidden" name="user_id" value="<?= $this->session->userdata("user_id")?>"> 
