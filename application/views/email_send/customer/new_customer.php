								...
								<table style="width: 100%; margin: auto; padding: 2rem; ">  
									...
									<tr>
										<td style="text-align: center;"> 
											<h1 style="color:#435ebe; font-size: 26px; font-weight: 800;  padding: 1rem; line-height: 1.8">تسجيل جديد</h1>
										</td> 
									</tr>
									<tr>
										<td style="text-align: center; color:#203444; font-size: 20px; text-align: right; line-height: 1.5"> 
											...
											كلمة المرور  : <span> <?= $customer_password?></span> <br>
									...
									<tr>
										<td style="padding: 3rem 0; text-align: center;">
											<a href="<?= site_url()?>customerValidateAccount/<?= $customer_id?>/<?= $customer_token?>" style=" width: 300px;height: 56px;line-height: 56px;background: #435ebe;color: #fff; display: inline-block; border-radius: 4px; text-align: center; text-decoration:none">
												تفعيل الحساب
											</a>
										</td> 
									</tr>
