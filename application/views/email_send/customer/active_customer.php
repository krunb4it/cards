								...
								<table style="width: 100%; margin: auto; padding: 2rem; ">  
									...
									<tr>
										<td style="text-align: center;"> 
											<h1 style="color:#435ebe; font-size: 26px; font-weight: 800;  padding: 1rem; line-height: 1.8">تفعيل الحساب</h1>
										</td> 
									</tr>
									<tr>
									...
									<tr>
										<td style="padding: 3rem 0; text-align: center;">
											<a href="<?= site_url()?>customerProfile" style=" width: 300px;height: 56px;line-height: 56px;background: #435ebe;color: #fff; display: inline-block; border-radius: 4px; text-align: center; text-decoration:none">
												الملف الشخصي
											</a>
										</td> 
									</tr>
