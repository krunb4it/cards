<div id="main">
    ...
    <div id="main-content"> 
		<div class="page-title mb-3">
			<div class="row">
				...
				<div class="col-12 col-md-6 order-md-1 order-last">
					<h3>اضافة زبون جديد</h3>
					<p class="text-subtitle text-muted">اضافة زبون جديد</p>
				</div>
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">اضافة زبون جديد</li> 
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="<?= site_url()?>customer/add_customer" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
					...
					<div class="col-xl-6 col-lg-9"> 
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">اضافة زبون جديد</h4> 
							</div>
								...
								<div class="card-body">
									<div class="form-body">
										<div class="row mb-4">
											...
											<div class="col-md-9"> 
												<div class="upload-pic-box">
													...
													<input type="file" class="form-control d-none upload-pic" id="profile_pic" name="customer_logo" id="formFile" required>
										...
										<div class="row"> 
											...
											<div class="col-md-9 form-group">
												<input type="email" class="form-control form-control-lg" name="customer_jawwal"> 
											</div>  
										</div>
										<div class="row"> 
											<div class="col-md-3">
											...
											<div class="col-md-9 form-group">
												<div class="input-group">
													<input type="text" readonly class="form-control" rel="gp" name="customer_password" data-size="12" data-character-set="a-z,A-Z,0-9,#">
