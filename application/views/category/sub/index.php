		...
		<div class="page-title mb-3">
			<div class="row">
				<div class="col-12 col-md-6 order-md-1 order-last">
					...
					<p class="text-subtitle text-muted">عرض التصنيفات الفرعية التابعة للتصنيف </p>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">عرض التصنيفات الفرعية</h4>
							<p class="footer">جلب البيانات في <strong>{elapsed_time}</strong> ثانية.</p>
							<a class="btn btn-primary" href="<?=site_url()?>category/new_sub_category/<?= $category_id?>"> اضافة تصنيف فرعي جديد</a>
						</div>
											...
											<table class="table w-auto table-borderless mb-0">
												<tr >
													...
													<td width="400" class="text-bold-500">
														<a class="btn btn-info me-2" href="<?=site_url()?>category/view_sub_category_id/<?= $s->category_id;?>"> تعديل</a>
