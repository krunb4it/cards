		...
		<div id="error"> 
			<div class="error-page container">
				<div class="col-lg-6 col-md-8 col-12 offset-lg-3 offset-md-2">
					<img class="img-error" src="<?=site_url()?>assets/images/samples/error-403.png" alt="Not Found">
					<div class="text-center">
						<h1 class="error-title">خطا 403</h1>
						<p class='fs-5 text-gray-600'>أنت غير مخول لرؤية هذه الصفحة.</p>
