							...
							<div class="card-body"> 
								<table class="table mb-0">
									...
									<tr id="card_id_<?= $s->card_id;?>">
										...
										<td >
											<span class="me-3"><?=  $s->card_amount?></span>
											<?php if($s->card_amount > $s->card_min_amount) {?>
												<span class="badge bg-success">متوفر</span>
											<?php }
											if(($s->card_amount <= $s->card_min_amount) and ($s->card_amount > 0 )){?>
												<span class="badge bg-warning"> شارف على الانتهاء</span>
											<?php } 
											if($s->card_amount == 0 ){?>
										...
										<td width="150" class="text-bold-500">
											<div class="btn-group">
												...
												<div class="dropdown-menu dropdown-menu-end" aria-labelledby="triggerId">
													...
													<a class="dropdown-item" href="<?= site_url()?>card/card_offer/<?= $s->card_id?>"> كافة العروض </a>
													<a class="dropdown-item" href="<?= site_url()?>card/card_charge/<?= $s->card_id?>"> حركات شحن الرصيد </a>
													<a class="dropdown-item" href="<?= site_url()?>card/sell/<?= $s->card_id?>"> حركات البيع </a>
